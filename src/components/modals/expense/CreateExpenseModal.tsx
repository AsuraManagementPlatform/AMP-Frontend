...
import { ExpenseItemsField } from '@/components/forms/ExpenseItemsField';
...
export const CreateExpenseModal: React.FC<CreateExpenseModalProps> = ({
    ...
    const onSubmit: SubmitHandler<CreateProjectBudgetData> = async (data) => {
        ...
        try {
            ...
            showToast.loading('Se creează cheltuiala...');

            const expenseData: ProjectBudgetCreateRequest = {
                ...data,
                projectId: data.projectId
            };

            const createdExpense = await budgetService.createProjectBudget(expenseData);
            
            showToast.success('Cheltuiala a fost creată cu succes!');
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6"><div className="space-y-4">
                    ...
                    <ExpenseItemsField control={control} watch={watch} register={register} />
                    {errors.items && (
