...
interface UploadMemberDocumentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  userId: string;
...
export const UploadMemberDocumentModal: React.FC<UploadMemberDocumentModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  userId,
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title={t('label.document.upload_personal_title')} size="md">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            {t('label.document.document_type_label')}
          </label>
          <select
            value={subcategory}
          ...
          >
            ...
            <option value="cv">{t('label.document.category_cv')}</option>
            ...
            <option value="diplome">{t('label.document.category_diplome')}</option>
            <option value="scrisoare_motivatie">{t('label.document.category_scrisoare_motivatie')}</option>
            <option value="recomandari">{t('label.document.category_recomandari')}</option>
